      ...
      <section className="container py-5">
        ...
        <div className="accordion" id="faqAccordion">
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                ...
                However, we provide shipping services across multiple locations
                within the country. Please check our shipping details for more
                information.
              </div>
            </div>
          </div>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                You can schedule a repair or maintenance service by visiting our
                services page and selecting a date and time. We offer in-store
                and mobile services.
              </div>
            </div>
          </div>
