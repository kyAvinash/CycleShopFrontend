  ...
  return (
    <main>
      <section
        ...
        style={{
          backgroundImage:
            "url('https://images.pexels.com/photos/1466493/pexels-photo-1466493.jpeg')",
      ...
      <section className="container text-center py-5">
        ...
        <p className="lead">
          Established in 2024, Cycle Wala started as a local shop and has grown
          into a global online community for cycle lovers. Our dedication to
          quality and passion for cycling drives us to continually innovate and
          inspire to make our planet greener and pollution-free.
        </p>
      </section>
          ...
          <div className="col-md-6">
            <div className="card h-100 p-4 d-flex flex-column">
              ...
              <p className="lead flex-grow-1">
                We offer a variety of products and services to cater to cycling
                enthusiasts and casual riders alike. Our offerings include:
                <br /> Bicycles, Accessories, Repairs and Maintenance,
                Customization, Rentals, and Bike Fitting.
              </p>
        ...
        <div className="row g-4">
          <div className="col-md-3">
            <div className="card text-center">
              <img
                src="https://avatars.githubusercontent.com/u/141410339?v=4"
                alt="Team Member"
          ...
          <div className="col-md-3">
            <div className="card text-center">
              <img
                src="https://avatars.githubusercontent.com/u/380492?v=4"
                alt="Team Member"
                className="card-img-top rounded-circle mx-auto mt-3"
                style={{ width: "100px" }}
              />
          ...
          <div className="col-md-3">
            <div className="card text-center">
              <img
                src="https://avatars.githubusercontent.com/u/546885?v=4"
                alt="Team Member"
                className="card-img-top rounded-circle mx-auto mt-3"
                style={{ width: "100px" }}
              />
          ...
          <div className="col-md-3">
            <div className="card text-center">
              <img
                src="https://avatars.githubusercontent.com/u/5777036?v=4"
                alt="Team Member"
                className="card-img-top rounded-circle mx-auto mt-3"
                style={{ width: "100px" }}
              />
